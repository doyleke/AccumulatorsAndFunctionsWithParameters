...
def print_sequence2():
    ...
    print(stupid_number)
    for k in range(17):
        new_stupid_number=stupid_number+20
        print(new_stupid_number)
        stupid_number = new_stupid_number
...
def draw_circles2():
    ...
    for k in range(21):
        for k in range(17):
            new_center=center+20
            return new_center
            center = new_center
    circle = rg.Circle(new_center, 10)
    print(new_center)
...
def draw_cosines_and_sines():
    ...
    for k in range(20):
        cos= 80+math.cos(k)
    center = rg.Point(200 + cos, 200 + cos)
    for k in range(21):
